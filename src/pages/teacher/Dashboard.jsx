  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="flex justify-between items-center mb-2">
        <div>
          <h2 className="text-xl sm:text-2xl md:text-3xl font-black text-slate-900 dark:text-slate-100 tracking-tight">Teacher Dashboard</h2>
          <p className="text-slate-600 dark:text-slate-400 font-bold text-xs mt-1">Welcome back, {authUser.name}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm p-6 flex flex-col items-center justify-center text-center min-h-[300px]">
          <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900/30 rounded-2xl flex items-center justify-center text-blue-700 dark:text-blue-300 mb-4 shadow-xs border border-blue-200">
            <Clock size={32} />
          </div>
          <h3 className="text-base sm:text-lg font-black text-slate-900 dark:text-slate-100 uppercase tracking-wider mb-2">Upcoming Class</h3>
