...
import { 
  ...
  CreditCard, Bell, Phone, LogOut, User, Sun, Moon 
} from 'lucide-react';
        ...
        <header className="bg-white border-b border-gray-200 h-16 flex items-center px-8 shrink-0 justify-end sticky top-0 z-10 shadow-sm">
           <div className="flex items-center space-x-4">
             ...
             <div className="flex items-center space-x-3">
               <div className="w-8 h-8 bg-greenAccent rounded-full flex items-center justify-center text-white font-bold text-sm uppercase overflow-hidden shadow-sm">
                 {avatar ? (
               ...
               <span className="text-sm font-medium text-gray-700 dark:text-slate-200">{authUser?.name || 'Parent'}</span>
             </div>
           </div>
        </header>
