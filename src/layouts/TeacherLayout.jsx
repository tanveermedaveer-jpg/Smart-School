...
import { 
  ...
  Calendar, Bell, User, LogOut, Sun, Moon, QrCode, DollarSign, Menu, X 
} from 'lucide-react';
        ...
        <header className="bg-white border-b border-gray-200 h-16 flex items-center px-4 sm:px-8 shrink-0 justify-between lg:justify-end sticky top-0 z-10 shadow-sm">
          ...
          <div className="flex items-center space-x-3">
             ...
             <div className="flex items-center space-x-2 sm:space-x-3">
               ...
               <span className="text-xs sm:text-sm font-medium text-gray-700 truncate max-w-[120px] sm:max-w-none">{authUser?.name || 'Teacher'}</span>
             </div>
           </div>
        </header>
